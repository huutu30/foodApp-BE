    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buoi', models.CharField(choices=[('SANG', 'Sang'), ('TRUA', 'Trua'), ('CHIEU', 'Chieu'), ('ALL', 'All')], default='SANG', max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, upload_to='%Y/%m')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('updated_date', models.DateTimeField(auto_now=True)),
                ('dish', models.ManyToManyField(related_name='menus', to='DatDoAnBEApp.dish')),
        ...
        migrations.AddField(
            model_name='dish',
            name='shop',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dishes', to='DatDoAnBEApp.shop'),
        ),
    ]
